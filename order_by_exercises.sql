...
ORDER BY first_name;
#Answer: 709 employees returned, Irena Reutenauer, Vidya Simmen
...
ORDER BY emp_no; 
#Answer: 899 employees returned, first= 10021, Erde Ramzi, Last= 499648 Erde Tadahiro
...
#Answer: 899 employees returned, NEWEST: Teiji Eldridge, OLDEST: Sergi Erde
...
FROM employees
WHERE hire_date < '2000-1-1' AND hire_date > '1989-12-31' #BETWEEN could have been used here?
	AND birth_date LIKE '%-12-25'
ORDER BY birth_date ASC, hire_date DESC;
#Answer: 362 employees returned, OLDEST: Khun Bernin, YOUNGEST: Douadi Pettis
